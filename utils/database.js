...
function registerAllDB(client) {
	const tables = [
		...
		{ name: 'Users', columns: { id: { type: Sequelize.STRING, primaryKey: true }, code: { type: Sequelize.STRING }, inviterName: { type: Sequelize.STRING }, inviterId: { type: Sequelize.INTEGER } } },
		{ name: 'Setup', columns: { actif: { type: Sequelize.STRING }, channelId: { type: Sequelize.STRING } } }
	]
